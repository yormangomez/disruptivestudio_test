...
import 'package:api_helper/src/errors/error_response.dart';
import 'package:api_helper/src/errors/server_response.dart';
import 'package:api_helper/src/service/service.dart';
  ...
  Future<ServerResponse> post(
    ...
    try {
      ...
      if (response.bodyBytes.isNotEmpty) {
        dataDecode = AppUtils.instance.getDataDecode(response.bodyBytes);
      }
      if (response.statusCode >= 200 && response.statusCode <= 204) {
        return ServerResponse(
